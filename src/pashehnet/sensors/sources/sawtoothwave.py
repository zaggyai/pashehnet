...
class SawtoothWaveSource(SensorSourceBase):
    ...
    def __init__(self, frequency, sample_rate, width=1.0):
        ...
        :param width: Width of the rising ramp as a proportion of the total cycle (default is 1.0)
        """
    ...
    def __next__(self):
        ...
        sawtooth_wave = signal.sawtooth(2 * np.pi * self.frequency * t, width=self.width)[0]
